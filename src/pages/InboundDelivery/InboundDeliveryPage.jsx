          ...
          <tbody>
            {loading ? (
              Array.from({ length: 5 }).map((_, i) => (
                <tr key={`skel-${i}`}>
                  <td><Skeleton height={16} width="80px" /></td>
                  <td><Skeleton height={16} width="100px" /></td>
                  <td><Skeleton height={16} width="90px" /></td>
                  <td><Skeleton height={16} width="90px" /></td>
                  <td><Skeleton height={16} width="140px" /></td>
                  <td><Skeleton height={16} width="60px" /></td>
                  <td><Skeleton height={24} width="100px" borderRadius={100} /></td>
                </tr>
              ))
            ) : filtered.length === 0 ? (
              <tr className="ibd-empty-row">
                <td colSpan={7}>No deliveries match your filters.</td>
              </tr>
            ) : (
              filtered.map((d) => (
