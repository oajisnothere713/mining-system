              ...
              {loading ? (
                Array.from({ length: 6 }).map((_, i) => (
                  <tr key={`skel-${i}`}>
                    ...
                    <td className="stock-td-right"><Skeleton height={16} width="60px" style={{ marginLeft: 'auto' }} /></td>
                    <td className="stock-td-right"><Skeleton height={16} width="60px" style={{ marginLeft: 'auto' }} /></td>
                    <td className="stock-td-right"><Skeleton height={16} width="60px" style={{ marginLeft: 'auto' }} /></td>
                    <td className="stock-td-right"><Skeleton height={16} width="60px" style={{ marginLeft: 'auto' }} /></td>
                    <td className="stock-td-right">
                      <Skeleton height={24} width="80px" borderRadius={8} style={{ marginLeft: 'auto' }} />
                    </td>
                    <td className="stock-td-right"><Skeleton height={16} width="20px" style={{ marginLeft: 'auto' }} /></td>
                  </tr>
                ))
              ) : (
                rows.map((r) => {
