    ...
    <div>
      ...
      <div className="detail-card">
          ...
          <tbody>
            {isUpdating ? (
              Array.from({ length: Math.max(1, lines.length) }).map((_, i) => (
                <tr key={`skel-${i}`}>
                  <td><Skeleton height={16} width="140px" /></td>
                  <td><Skeleton height={20} width="60px" borderRadius={4} /></td>
                  <td><Skeleton height={16} width="50px" /></td>
                  <td><Skeleton height={28} width="80px" borderRadius={6} /></td>
                  <td><Skeleton height={16} width="30px" /></td>
                  <td><Skeleton height={16} width="70px" /></td>
                </tr>
              ))
            ) : (
              lines.map((l, i) => {
        ...
        <div className="detail-actions">
          {isUpdating ? (
            <div style={{ textAlign: 'center', color: 'var(--slate)', fontSize: 14, fontWeight: 500, padding: 12 }}>
              Processing update...
            </div>
          ) : done ? (
